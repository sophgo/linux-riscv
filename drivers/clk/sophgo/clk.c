...
/* pll clock init */
int mango_register_pll_clks(struct device *dev,
...
/* mux clk init */
int mango_register_mux_clks(struct device *dev, struct mango_clk_data *clk_data)
{
	int ret;
	int count;
...
/* pll divider init */
int mango_register_div_clks(struct device *dev, struct mango_clk_data *clk_data)
{
	int ret;
	int count;
