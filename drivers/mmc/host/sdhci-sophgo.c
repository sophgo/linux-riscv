...
static void bm_sdhci_reset(struct sdhci_host *host, u8 mask)
{
#if 0 // FIXME, SD card not working after this.
...
static void bm_sdhci_set_clock(struct sdhci_host *host, unsigned int clock)
{
...
static int bm_platform_execute_tuning(struct sdhci_host *host, u32 opcode)
{
	u16 ctrl;
