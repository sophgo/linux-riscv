...
static ssize_t brdid_show(struct device *dev, struct device_attribute *attr,
		    char *buf)
{
	int err = 0;
...
static ssize_t brdip_show(struct device *dev, struct device_attribute *attr,
		    char *buf)
{
	u8 ip[4];
	int err;
...
static ssize_t uptime_show(struct device *dev, struct device_attribute *attr,
		    char *buf)
{
	u8 t[2];
	int err;
...
static ssize_t alert_show(struct device *dev, struct device_attribute *attr,
		   char *buf)
{
	int cnt = 0;
	int i, err;
